...
from diffusers import DPMSolverMultistepScheduler, StableDiffusionXLControlNetInpaintPipeline
...
class SDXL_Pipeline():
    ...
    def generate_img(self, prompt,negative_prompt, bg_image, mask_image,controlnet_image_path, controlnet_scale, control_guidance_start, control_guidance_end, lora_weights, cfg, steps, seed=None, width=1024, height=1024):
