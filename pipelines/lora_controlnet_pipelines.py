...
from diffusers import StableDiffusionXLControlNetPipeline, DPMSolverMultistepScheduler
...
class SDXL_Pipeline():
    ...
    def __init__(self, base_pipeline_path, additional_controlnet_paths=None, additional_loras=None, use_refiner=True, clip_skip=0,use_ip_adapter=False, use_distributed=False):
